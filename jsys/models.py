...
class Available(_D.Model):
    id = _D.Column(_D.Integer, primary_key=True)
    emp_id = _D.Column(_D.Integer, _D.ForeignKey('employee.id'), nullable=False)
    monday = _D.Column(_D.String(20), nullable=False, default='All day')
    tuesday = _D.Column(_D.String(20), nullable=False, default='All day')
    wednesday = _D.Column(_D.String(20), nullable=False, default='All day')
    thursday = _D.Column(_D.String(20), nullable=False, default='All day')
    friday = _D.Column(_D.String(20), nullable=False, default='All day')
    saturday = _D.Column(_D.String(20), nullable=False, default='All day')
    sunday = _D.Column(_D.String(20), nullable=False, default='All day')
